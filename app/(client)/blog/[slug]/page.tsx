  ...
  return (
    <div>
      <div className="border border-lightColor p-5 rounded-md">
        <Heading className="text-base">Blog Categories</Heading>
        <div className="space-y-2 mt-2">
          {categories?.map(({ blogcategories }: {blogcategories: BlogCategory[]}, index: number) => (
            <div
              key={index}
      ...
      <div className="border border-lightColor p-5 rounded-md mt-10">
        <Heading className="text-base">Latest Blogs</Heading>
