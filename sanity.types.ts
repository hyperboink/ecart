...
// Variable: SPECIAL_DEAL_PRODUCTS_QUERY
// Query: *[_type == 'product' && status == 'hot'] | order(name asc){        ...,        'categories': categories[]->title    }
export type SPECIAL_DEAL_PRODUCTS_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: PRODUCT_BRAND_QUERY
// Query: *[_type == "product" && slug.current == $slug]{    "brandName": brand->title}
export type PRODUCT_BRAND_QUERYResult = Array<{
